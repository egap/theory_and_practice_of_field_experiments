...
author: Jake Bowers,^[Author order randomized. https://jakebowers.org] Maarten Voors,^[https://sites.google.com/site/maartenvoors/] and Nahomi Ichino^[https://www.nahomiichino.com/]
...
link-citations: yes
colorlinks: yes
github-repo: egap/learningdays-book
...
You can copy this book or parts thereof (e.g., slides, etc.) either by using the Download button on the front page of <http://github.com/egap/learningdays-book> or by using github directly (by forking this repository).
...
If you have any questions, feedback or have organized your own event, please get in touch! Simply post an issue on [Github](https://github.com/egap/learningdays-book/issues) or contact us via email, admin@egap.org.
