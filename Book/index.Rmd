...
## Suggested Structure of Workshop Sessions

We have had experience with Learning Days workshops with students who have some previous experience with statistics and experiment as well as with students who have little to no previous experience. For the students with more experience and training, we advise following the structure of the book itself (and see LINK to syllabi/workshop agendas from Latin America). For audiences with very little previous exposure and experience we recommend the following structure.

+---------------+---------------+--------------------+
| Design        | Randomization | Estimation | Testing | Power | Threats | Slides |
+===============+===============+====================+
| Completely Randomized       | `complete_ra`        |   |
+---------------+---------------+--------------------+
| Block Randomized       | | |
+---------------+---------------+--------------------+
| Cluster Randomized       | | |
