...
- For **Mac OS X**: [https://cran.r-project.org/bin/macosx/](https://cran.r-project.org/bin/macosx/).   
    - Select `R-4.0.4.pkg` for OS X 10.13 and higher.
...
RStudio can be freely downloaded from the RStudio website, [https://www.rstudio.com/products/rstudio/download/](https://www.rstudio.com/products/rstudio/download/). In the table, click the blue `Download` button at the top of the left column, "RStudio Desktop Open Source License" as depicted below in Figure 1. Once you select this button, the page will jump to a list of download options as depicted in Figure 2.
...
```{r echo=TRUE}
(a <- 5)     # "<-"  is the assignment command; it is used to
             # define things. eg:
```
