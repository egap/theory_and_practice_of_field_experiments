...
You can copy this book or parts thereof (e.g., slides, etc.) either by using the Download button on the front page of \url{http://github.com/egap/learningdays-book} or by using github directly (by forking this repository).
...
If you have any questions, feedback or have organized your own event, please get in touch! Simply post an issue on \href{https://github.com/egap/learningdays-book/issues}{Github} or contact us via email, \href{mailto:admin@egap.org}{\nolinkurl{admin@egap.org}}.
